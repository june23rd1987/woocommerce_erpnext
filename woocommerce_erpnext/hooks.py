...
doc_events = {
    "Item": {
        "on_update": "woocommerce_erpnext.woo_connector.on_validate_item",
	"after_delete": "woocommerce_erpnext.woo_connector.on_delete_item"
    },
    "Delivery Note": {
	"on_submit":"woocommerce_erpnext.woo_connector.on_delivery_submit",
	"on_cancel":"woocommerce_erpnext.woo_connector.on_delivery_cancel"
    }
}
